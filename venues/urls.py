...
urlpatterns = [
    ...
    path('reservation/<int:reservation_id>/seen/<str:seen_state>/',                 views.update_reservation_seen,              name='update_reservation_seen'),
    path('reservation/<int:reservation_id>/details/',                               views.reservation_details_api,              name='reservation_details_api'),
