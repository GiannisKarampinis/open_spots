...
// Temporarily disabled until these React pages are added to the repository:
		...
		<>
			...
			<Routes>
				<Route element={<Layout />}>
					...
					{/* Temporarily disabled until SocialLoginCompletePage is added. */}
					{/* <Route path="/accounts/social-login-complete" element={<SocialLoginCompletePage />} /> */}
					{/* <Route path="/accounts/social-login-complete/" element={<SocialLoginCompletePage />} /> */}

					<Route path="/venues/about" element={<AboutPage />} />
					{/* Temporarily disabled until the corresponding React pages are added. */}
